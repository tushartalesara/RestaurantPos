-- Run this after:
-- 1) 005_order_contact_and_short_code.sql
-- 2) 006_active_pending_order_ids.sql
--
-- Purpose:
-- Recreate the place_voice_order_atomic(...) RPC with the latest signature
-- and behavior, then refresh the PostgREST schema cache.
